#Parameetreid muudetud ja lisatud Ralf Tambetsi poolt
...
runMatrixEQTL <- function(exp_data, geno_data, snpspos, genepos, covariates = NULL, 
                          cisDist = 5e5, outputFileName="", pvOutputThreshold = 1e-2, permute = FALSE, model = modelLINEAR, noFDRsaveMemory = FALSE){
